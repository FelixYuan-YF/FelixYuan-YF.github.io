    ...
    <li>
      <div class="pub-row">
        ...
        <div class="col-sm-9" style="position: relative;">
          ...
          <div class="links">
            <a href="https://arxiv.org/abs/2509.09676" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Arxiv</a>
            ...
            <a href="https://github.com/NJU-3DV/spatialVID" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Github</a>
            <a href="https://huggingface.co/SpatialVID" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">HuggingFace</a>
